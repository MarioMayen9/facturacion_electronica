          ...
          {isProfileOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50 touch-manipulation">
              <div className="py-2">
                ...
                <button 
                  className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 transition-colors touch-manipulation"
                ...
                <button 
                  ...
                  className="w-full text-left px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition-colors touch-manipulation"
                  style={{ backgroundColor: '#FFFFFF' }}
                >
                  Cerrar Sesión
                </button>
